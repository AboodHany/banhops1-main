...
class DemoTransitCatalog {
  ...
  static const List<LocationNode> cairoCities = [
    ...
    // Metro Line 1
    LocationNode(id: 601, name: 'Helwan University', latitude: 29.8660, longitude: 31.3150, type: TransitLocationType.station, alias: 'Metro Line 1', governorate: 'Cairo'),
    LocationNode(id: 602, name: 'Maadi', latitude: 29.9602, longitude: 31.2598, type: TransitLocationType.station, alias: 'Metro Line 1', governorate: 'Cairo'),
    LocationNode(id: 603, name: 'Sayeda Zeinab', latitude: 30.0298, longitude: 31.2330, type: TransitLocationType.station, alias: 'Metro Line 1', governorate: 'Cairo'),
    LocationNode(id: 604, name: 'Hadayek El-Kobba', latitude: 30.0880, longitude: 31.2930, type: TransitLocationType.station, alias: 'Metro Line 1', governorate: 'Cairo'),
    LocationNode(id: 605, name: 'El-Marg El-Jedida', latitude: 30.1600, longitude: 31.3400, type: TransitLocationType.station, alias: 'Metro Line 1', governorate: 'Cairo'),
    LocationNode(id: 606, name: 'Sadat Metro', latitude: 30.0444, longitude: 31.2357, type: TransitLocationType.station, alias: 'Metro Line 1/2 Hub', governorate: 'Cairo'),
    LocationNode(id: 607, name: 'Nasser Metro', latitude: 30.0535, longitude: 31.2403, type: TransitLocationType.station, alias: 'Metro Line 1/3 Hub', governorate: 'Cairo'),
    LocationNode(id: 608, name: 'Attaba Metro', latitude: 30.0526, longitude: 31.2472, type: TransitLocationType.station, alias: 'Metro Line 2/3 Hub', governorate: 'Cairo'),
    LocationNode(id: 609, name: 'Al-Shohadaa Metro', latitude: 30.0617, longitude: 31.2467, type: TransitLocationType.station, alias: 'Metro Line 1/2 Ramses', governorate: 'Cairo'),
    
    // Metro Line 2 (Cairo side)
    LocationNode(id: 705, name: 'El-Mazallat Metro', latitude: 30.1042, longitude: 31.2492, type: TransitLocationType.station, alias: 'Metro Line 2', governorate: 'Cairo'),
    LocationNode(id: 706, name: 'Rod El-Farag Metro', latitude: 30.0864, longitude: 31.2458, type: TransitLocationType.station, alias: 'Metro Line 2', governorate: 'Cairo'),
    LocationNode(id: 707, name: 'Massarra Metro', latitude: 30.0769, longitude: 31.2450, type: TransitLocationType.station, alias: 'Metro Line 2', governorate: 'Cairo'),
    LocationNode(id: 708, name: 'Mohamed Naguib Metro', latitude: 30.0441, longitude: 31.2435, type: TransitLocationType.station, alias: 'Metro Line 2', governorate: 'Cairo'),
    LocationNode(id: 709, name: 'Opera Metro', latitude: 30.0425, longitude: 31.2267, type: TransitLocationType.station, alias: 'Metro Line 2', governorate: 'Cairo'),

    // Metro Line 3
    LocationNode(id: 801, name: 'Nadi El-Shams', latitude: 30.1150, longitude: 31.3450, type: TransitLocationType.station, alias: 'Metro Line 3', governorate: 'Cairo'),
    LocationNode(id: 802, name: 'Abassia', latitude: 30.0650, longitude: 31.2820, type: TransitLocationType.station, alias: 'Metro Line 3', governorate: 'Cairo'),
    LocationNode(id: 803, name: 'Kit Kat', latitude: 30.0720, longitude: 31.2110, type: TransitLocationType.station, alias: 'Metro Line 3', governorate: 'Cairo'),
    
    // LRT
    LocationNode(id: 901, name: 'El-Shorouk', latitude: 30.1410, longitude: 31.6320, type: TransitLocationType.station, alias: 'LRT Line', governorate: 'Cairo'),
    LocationNode(id: 902, name: 'Badr City', latitude: 30.1380, longitude: 31.7350, type: TransitLocationType.station, alias: 'LRT Line', governorate: 'Cairo'),
    ...
    LocationNode(id: 904, name: 'Arts & Culture City', latitude: 30.0120, longitude: 31.6980, type: TransitLocationType.station, alias: 'LRT Line', governorate: 'Cairo'),
    ...
    LocationNode(id: 1002, name: 'Fifth Settlement', latitude: 30.0050, longitude: 31.4210, type: TransitLocationType.station, alias: 'East Monorail', governorate: 'Cairo'),
    LocationNode(id: 1003, name: 'AUC Station', latitude: 30.0210, longitude: 31.5030, type: TransitLocationType.station, alias: 'East Monorail', governorate: 'Cairo'),
    LocationNode(id: 1004, name: 'Governmental District', latitude: 29.9880, longitude: 31.6850, type: TransitLocationType.station, alias: 'East Monorail', governorate: 'Cairo'),
  ];
  ...
  static const List<LocationNode> gizaCities = [
    ...
    LocationNode(id: 702, name: 'Cairo University', latitude: 30.0260, longitude: 31.2010, type: TransitLocationType.station, alias: 'Metro Line 2', governorate: 'Giza'),
    LocationNode(id: 703, name: 'El-Mounib', latitude: 29.9810, longitude: 31.2090, type: TransitLocationType.station, alias: 'Metro Line 2', governorate: 'Giza'),
    LocationNode(id: 710, name: 'El-Bohouth Metro', latitude: 30.0358, longitude: 31.2003, type: TransitLocationType.station, alias: 'Metro Line 2', governorate: 'Giza'),
    
    // Metro Line 3 West
    LocationNode(id: 804, name: 'Rod El-Farag Axis', latitude: 30.0910, longitude: 31.1850, type: TransitLocationType.station, alias: 'Metro Line 3', governorate: 'Giza'),
    ...
    LocationNode(id: 1102, name: 'Hyper One', latitude: 30.0150, longitude: 30.9850, type: TransitLocationType.station, alias: 'West Monorail', governorate: 'Giza'),
    ...
    LocationNode(id: 1104, name: 'Bashtiel Station', latitude: 30.0820, longitude: 31.1980, type: TransitLocationType.station, alias: 'West Monorail', governorate: 'Giza'),
  ];

  static const List<LocationNode> qalyubiaCities = [
    LocationNode(id: 301, name: 'Benha', latitude: 30.4607, longitude: 31.1865, type: TransitLocationType.station, alias: 'Capital of Qalyubia', governorate: 'Qalyubia'),
    ...
    LocationNode(id: 311, name: 'Shiblanga', latitude: 30.4967, longitude: 31.2728, type: TransitLocationType.station, alias: 'Shiblanga Station', governorate: 'Qalyubia'),
    
    // Metro Line 2 (Shubra branch)
    LocationNode(id: 701, name: 'Faculty of Agriculture Metro', latitude: 30.1150, longitude: 31.2520, type: TransitLocationType.station, alias: 'Metro Line 2', governorate: 'Qalyubia'),
  ...
  static const List<LocationNode> menofiaCities = [
    ...
    LocationNode(id: 327, name: 'Birket El-Sab', latitude: 30.6291, longitude: 31.0824, type: TransitLocationType.station, alias: 'Birket El-Sab Station', governorate: 'Menofia'),
  ...
  static const List<LocationNode> gharbiaCities = [
    LocationNode(id: 331, name: 'Tanta', latitude: 30.7865, longitude: 31.0004, type: TransitLocationType.station, alias: 'Delta Capital', governorate: 'Gharbia'),
    ...
    LocationNode(id: 334, name: 'Samanoud', latitude: 30.9622, longitude: 31.2425, type: TransitLocationType.station, alias: 'Samanoud Station', governorate: 'Gharbia'),
  ];
  ...
  static const List<LocationNode> dakahliaCities = [
    ...
    LocationNode(id: 345, name: 'Sherbin', latitude: 31.1928, longitude: 31.5272, type: TransitLocationType.station, alias: 'Sherbin Station', governorate: 'Dakahlia'),
  ];
  ...
  static const List<LocationNode> otherGovCities = [
    LocationNode(id: 401, name: 'Alexandria City', latitude: 31.2001, longitude: 29.9187, type: TransitLocationType.station, alias: 'Second Capital', governorate: 'Alexandria'),
    ...
    LocationNode(id: 361, name: 'Minya El-Qamh', latitude: 30.5119, longitude: 31.3465, type: TransitLocationType.station, alias: 'Minya El-Qamh Station', governorate: 'Sharqia'),
    LocationNode(id: 362, name: 'Abu Hammad', latitude: 30.5444, longitude: 31.6797, type: TransitLocationType.station, alias: 'Abu Hammad Station', governorate: 'Sharqia'),
    LocationNode(id: 371, name: 'Itay El-Baroud', latitude: 30.8870, longitude: 30.6650, type: TransitLocationType.station, alias: 'Itay El-Baroud Station', governorate: 'Beheira'),
    LocationNode(id: 372, name: 'Kafr El-Dawar', latitude: 31.1342, longitude: 30.1294, type: TransitLocationType.station, alias: 'Kafr El-Dawar Station', governorate: 'Beheira'),
    LocationNode(id: 373, name: 'Abu Hummus', latitude: 31.0022, longitude: 30.3094, type: TransitLocationType.station, alias: 'Abu Hummus Station', governorate: 'Beheira'),
    LocationNode(id: 381, name: 'El-Tell El-Kebir', latitude: 30.5606, longitude: 31.9161, type: TransitLocationType.station, alias: 'El-Tell El-Kebir Station', governorate: 'Ismailia'),
    LocationNode(id: 382, name: 'El-Kassasin', latitude: 30.5636, longitude: 32.0256, type: TransitLocationType.station, alias: 'El-Kassasin Station', governorate: 'Ismailia'),
    LocationNode(id: 383, name: 'Qantara West', latitude: 30.7761, longitude: 32.3061, type: TransitLocationType.station, alias: 'Qantara West Station', governorate: 'Ismailia'),
  ];
  ...
  static const List<LocationNode> benhaDestinations = [
    ...
    LocationNode(id: 102, name: 'Benha Train Station', latitude: 30.4607, longitude: 31.1865, type: TransitLocationType.station, alias: 'Rail Hub', governorate: 'Qalyubia'),
