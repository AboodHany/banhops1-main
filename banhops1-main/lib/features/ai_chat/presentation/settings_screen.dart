...
import 'package:banhops1/features/ai_chat/utilities/animated_dialog.dart';
...
import 'package:banhops1/features/ai_chat/widgets/app_icon_button.dart';
import 'package:banhops1/features/ai_chat/widgets/app_screen_scaffold.dart';
import 'package:banhops1/features/ai_chat/widgets/build_display_image.dart';
import 'package:banhops1/features/ai_chat/widgets/profile_avatar.dart';
import 'package:banhops1/features/ai_chat/widgets/settings_tile.dart';
import 'package:banhops1/features/ai_chat/widgets/theme_mode_selector.dart';
import 'package:banhops1/core/state/app_state.dart';
            ...
            Card(
              child: ThemeModeSelector(
                ...
                onChanged: (value) {
                  ...
                  // Synchronize with host app global theme Mode
                  final appState = context.read<AppState>();
                  final currentIsDark = appState.themeMode == ThemeMode.dark;
                  final selectedIsDark = value == AppThemeMode.dark;
                  if (value == AppThemeMode.auto) {
                    ...
                    if (currentIsDark != selectedIsDark) {
                      appState.toggleThemeMode();
                    }
                  }
                },
